...
class ProjectController(app_manager.RyuApp):
    ...
    def get_topology(self, ev):
        ...
        for link in links_list:
            ...
            self.links.append((link.src.dpid,link.dst.dpid,{'port':link.src.port_no}))
        """
        self.net.add_edges_from(links)
        ...
        """
        for link in links_list:
            links.append((link.src.dpid,link.dst.dpid,{'port':link.dst.port_no}))
            self.links.append((link.src.dpid,link.dst.dpid,{'port':link.dst.port_no}))
        """
        self.net.add_edges_from(links)
