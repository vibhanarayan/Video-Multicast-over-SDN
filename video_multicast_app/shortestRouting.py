...
class ShortestRouting(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        """
        if arpPkt is not None and arpPkt.dst_ip == '10.0.2.15':
            ...
            e = ethernet.ethernet(dst=eth.src, src='08:00:27:a0:d2:9f', ethertype=eth.ethertype)
            a = arp.arp(opcode=arp.ARP_REPLY, src_mac='08:00:27:a0:d2:9f',
                        src_ip='10.0.2.15', dst_mac=arpPkt.src_mac,
        ...
        elif udp_pkt and ip_pkt.dst == '10.0.2.15':
            print "UDP ", udp_pkt
            if udp_pkt.dst_port == 8000:
                ...
                reply.add_protocol(ipv4.ipv4(version=4,
                                   ...
                                   src=ip_pkt.dst,
                                   dst=out_ip))
                reply.add_protocol(udp.udp(src_port=8000))
